...
function App() {
  ...
  // ✅ SEARCH FILTER LOGIC — name aur category dono se search
  ...
  // ✅ CATEGORY FILTERS + SEARCH APPLY
  const fruitsData    = filterBySearch(products.filter(p => p.category === "fruit"));
  const vegetables    = filterBySearch(products.filter(p => p.category === "vegetable"));
  const groceries     = filterBySearch(products.filter(p => p.category === "groceries"));
  const homemade      = filterBySearch(products.filter(p => p.category === "homemade"));

  // ✅ Search active hai to kuch results mila ya nahi
  ...
  // ✅ SECTION COMPONENT — agar search active hai aur section empty hai to hide karo
  const Section = ({ title, data, id }) => {
    // Search active hai aur is section mein kuch nahi — hide karo
      ...
      <div id={id} className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 pb-2">
          {data.length === 0 ? (
            ...
            data.map((item, i) => (
              <div key={i} className="w-full md:min-w-[220px]">
            ...
            <div className="max-w-7xl mx-auto px-3 md:px-6 py-4 md:py-6">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
                ...
                <div className="md:col-span-9 space-y-4 md:space-y-6">
                  ...
                  {/* ✅ HERO — search active nahi ho tab dikhao */}
                  {!searchQuery && (
                    <div className="bg-white rounded-2xl shadow-sm p-4 md:p-6">
                      <div className="flex flex-col-reverse md:grid md:grid-cols-2 items-center gap-4">
                        <div className="text-center md:text-left">
                          ...
                          <p className="text-green-600 mt-1 font-medium text-xs md:text-sm">
                  ...
                  {/* ✅ OFFER — search active nahi ho tab dikhao */}
                  {!searchQuery && (
                    <div className="bg-green-100 border border-green-200 p-3 md:p-4 rounded-xl flex items-center gap-3 shadow-sm">
                      <span className="bg-yellow-400 px-3 py-1 rounded text-white text-xs font-semibold">
                        SPECIAL OFFER
                      </span>
                      <p className="text-gray-700 text-xs md:text-sm">
                        We also buy grocery and other things which you want from the market & deliver to your door step same day —
                  ...
                  {/* ✅ PRODUCTS SECTIONS */}
                  <Section title="🍎 Fruits" data={fruitsData} id="fruits" />
                  <Section title="🥦 Vegetables" data={vegetables} id="vegetables" />
                  <Section title="🛒 Groceries" data={groceries} id="groceries" />
                  <Section title="🏠 Homemade Items(7 Days pre-order)" data={homemade} id="homemade" />

                  {/* ADDONS — search active nahi ho tab dikhao */}
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">
                        Not satisfied with quality? Return on the spot. We'll replace it or refund you.
                      </p>
                    </div>
                  </div>
                  <hr />
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">Market items delivered instantly (9AM–9PM)</p>
                    </div>
                  </div>
                  <hr />
                ...
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <a
                        href="https://www.instagram.com/kisan_direct?igsh=MTZzOW5mNHF0cHZwNg=="
                        target="_blank"
                        ...
                        style={{
                          ...
                          textDecoration: "none", fontWeight: "600", fontSize: "13px", width: "fit-content",
                        }}
                      >
                      ...
                      <a
                        href="https://www.tiktok.com/@kisan_direct?_r=1&_t=ZS-96J36h3vVll"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          display: "flex", alignItems: "center", gap: "10px",
                          background: "#010101", border: "1px solid #333",
                          color: "#fff", padding: "9px 16px", borderRadius: "10px",
                          textDecoration: "none", fontWeight: "600", fontSize: "13px", width: "fit-content",
                        }}
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                          ...
                          <path d="M18.58 6.59a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V8.91a6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.59a8.18 8.18 0 0 0 4.78 1.52V6.69a4.85 4.85 0 0 1-1-.1z" fill="#69C9D0" opacity="0.5"/>
                        </svg>
                        TikTok
                      </a>
